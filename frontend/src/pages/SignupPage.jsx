...
export default function SignupPage() {
      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-6">
        <Card className="w-full max-w-md border-border bg-card/50 backdrop-blur-sm">
          <CardContent className="pt-6 text-center">
            ...
            <h2 className="font-outfit text-2xl font-bold mb-2">Kayıt Başarılı!</h2>
            <p className="text-muted-foreground mb-6">
              Email adresinize bir doğrulama linki gönderdik. 
              Lütfen email'inizi kontrol edin ve hesabınızı doğrulayın.
            </p>
            <Link to="/login">
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-6" data-testid="signup-page">
      ...
      <div className="w-full max-w-md relative">
        ...
        <Card className="border-border bg-card/50 backdrop-blur-sm">
          <CardHeader className="text-center">
            <CardTitle className="font-outfit text-2xl">Hesap Oluştur</CardTitle>
