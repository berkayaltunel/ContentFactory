...
python3 -u scripts/collect_viral_tweets.py \
    --niche haber --min-likes 20 --max-pages 10 \
...
python3 -u scripts/collect_viral_tweets.py \
    --niche kripto --min-likes 20 --max-pages 10 \
...
python3 -u scripts/collect_viral_tweets.py \
    --niche mizah --min-likes 20 --max-pages 10 \
...
python3 -u scripts/collect_viral_tweets.py \
    --niche icerik_uretici --min-likes 20 --max-pages 10 \
...
python3 -u scripts/collect_viral_tweets.py \
    --niche finans --min-likes 20 --max-pages 10 \
...
python3 -u scripts/collect_viral_tweets.py \
    --niche tech --min-likes 20 --max-pages 10 \
...
python3 -u scripts/collect_viral_tweets.py \
    --niche pazarlama --min-likes 20 --max-pages 10 \
...
python3 -u scripts/collect_viral_tweets.py \
    --niche kisisel_gelisim --min-likes 20 --max-pages 10 \
